...
class EmployeeMyProfileReviewsCommentsAdapter(private val reviews: List<LegacyReview>) :
    RecyclerView.Adapter<EmployeeMyProfileReviewsCommentsAdapter.ReviewsCommentsViewHolder>() {
