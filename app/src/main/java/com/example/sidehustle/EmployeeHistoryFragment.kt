...
class EmployeeHistoryFragment : Fragment() {
    lateinit var binding: FragmentEmployeeHistoryBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_employee_history,container,false)
